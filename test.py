...
class TestMod(loader.Module):
    ...
    def __init__(self):
        self._memory = {}
        self._mods = {}  # Хранилище модулей для каждого клиента
    ...
    async def client_ready(self):
        ...
        client_logger.debug("Bot logging installed for %s", self.logchat)

        # Регистрируем модуль для этого клиента
        self._mods[self._client.tg_id] = self
